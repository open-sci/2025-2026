...
-----------
    ...
    - "Multidisciplinary" cannot be meaningfully mapped to a single LOC class
      by design.
...
def resolve_row(
    ...
    # Fall back to DOAJ if Scimago data was present but yielded no LOC match
...
def main():
    ...
    # Split into resolved and unresolved rows
